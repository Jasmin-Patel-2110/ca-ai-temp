...
export const INDUSTRY_MAPPING: IndustryMapping[] = [
  {
    ...
    category: {
      ...
      "Purchase Accounts": [
        "Discount on Purchase [GST@5%]",
        "Income Reflected in 26AS [Reversed]",
        "Laptop Purchase",
        "Machinery Purchase",
        "Purchase Share",
        "Purchase - Tax Invoice - 12%",
        "Purchase Tax Invoice - 18%",
        "Purchase Tax Invoice - 5%",
        "Purchase - Yarn (URD)",
        "Rate Diffrence[GST@5%]",
        "Trading Grey Purchase [GST@5%]",
        "Trading Grey Purchase [URD]"
      ],
      "Direct Expenses": [
        "Factory Exps [GST@12%]",
        "Gas Exps",
      ...
      "Indirect Expenses": [
        ...
        "Bank Charge",
        "Cc Renewal Fees",
        "Collection Man Salary Expenses",
        "Conveyance Exps",
        "Demate Charge",
        "Depreciation",
        "Factory Insurance",
        "freight expenses-GST @12%",
        "GST Exps",
        "Gujrat Gas",
        "Insurance [GST@18%]",
        "Interest Exps",
        ...
        "Loan Proceessing Charge",
        "Miscellaneous Expenses",
        "Professional Fees",
        "Professional Fees Exps Non GST",
        "Professional Fees Non GST",
        "Repairing Exps",
        "Rounding Off",
        "Spare Parts Exp-18%",
        "Staff Salary Expenses",
        "Stationary Expense [Gst@12%]",
        "Stationery & Printing Exps",
        "Telephone Exps",
        "Vatav Kasar",
      ...
      "Sales Accounts": [
        "Income Relflected in 26AS",
        "Rate Differance Sale[GST@5%]",
        "Sales - Grey",
        "Sales Tax Invoice",
        "Sales - Yarn",
        "Trading Grey [GST@5%]",
...
export const getIndustries = (): string[] => {
  return INDUSTRY_MAPPING.map((item) => item.industry);
};

export const getCategoriesByIndustry = (industryName: string): string[] => {
  const item = INDUSTRY_MAPPING.find((i) => i.industry === industryName);
  return item ? Object.keys(item.category) : [];
};

export const getSubCategories = (industryName: string, categoryName: string): string[] => {
  const item = INDUSTRY_MAPPING.find((i) => i.industry === industryName);

...
export default function InvoicesPage() {
  ...
  const handlePanelSave = () => {
    ...
    setPanelOpen(false);
    success({ message: "Changes staged. Click 'Save All Changes' to persist." });
  };
        ...
        >
          ...
          <td className="px-2 py-2 min-w-[130px]">
            <EditableCell
              ...
              onChange={(val) => setFieldValue(inv, "invoice_number", val)}
              isEdited={isFieldEdited(inv, "invoice_number")}
            />
          </td>
      ...
      <Sheet open={panelOpen} onOpenChange={setPanelOpen}>
        ...
        >
          <SheetHeader className="px-6 pt-6 pb-4 border-b border-border sticky top-0 bg-background z-10">
            ...
            <SheetDescription>
              Edit all fields for this invoice. Changes are staged until you save.
            </SheetDescription>
          </SheetHeader>
